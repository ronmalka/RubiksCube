...
int main(int argc,char *argv[])
{
	...
	const float myNEAR = 1.0f;
	const float myFAR = 1000.0f;
	...
	Renderer* rndr = new Renderer(CAMERA_ANGLE, (float)DISPLAY_WIDTH  / DISPLAY_HEIGHT, myNEAR, myFAR); // adding a camera
